...
export default function Visits() {
  ...
  const [gpsCoordinates, setGpsCoordinates] = useState('19.0760, 72.8777'); // Default Mumbai
            ...
            <form onSubmit={handleSubmitVisit} className="space-y-4">
              ...
              <div className="space-y-1">
                <div className="flex items-center justify-between">
                  <label className="text-[9px] font-semibold text-neutral-500 uppercase tracking-wide">Attach Shop Photos</label>
                  <button 
              ...
              <div className="space-y-2 pt-2">
                ...
                {signature && (
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    <span className="text-[10px] text-neutral-500">Signature captured!</span>
          ...
          <div className="w-full max-w-md bg-white border border-neutral-100 rounded-3xl shadow-2xl p-6 relative">
            ...
            <div className="space-y-4">
              ...
              {selectedVisit.photos?.length > 0 && (
                <div>
                  <span className="text-[9px] font-bold text-neutral-400 uppercase">Captured Photos</span>
