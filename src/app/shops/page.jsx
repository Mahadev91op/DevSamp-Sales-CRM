          ...
          <div className="w-full max-w-xl bg-white border border-neutral-100 rounded-3xl shadow-2xl p-6 relative overflow-y-auto max-h-[90vh]">
            ...
            <form onSubmit={handleAddShop} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1">
                  <label className="text-[9px] font-semibold text-neutral-500 uppercase tracking-wide">Store Name *</label>
                  <input 
                    required
                ...
                <div className="space-y-1">
                  <label className="text-[9px] font-semibold text-neutral-500 uppercase tracking-wide">Owner Name *</label>
                  <input 
                    required
                ...
                <div className="space-y-1">
                  <label className="text-[9px] font-semibold text-neutral-500 uppercase tracking-wide">Mobile Number *</label>
                  <input 
                    required
              ...
              <div className="space-y-1">
                <label className="text-[9px] font-semibold text-neutral-500 uppercase tracking-wide">Address Details *</label>
                <textarea 
                  required rows={2}
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="space-y-1">
                  <label className="text-[9px] font-semibold text-neutral-500 uppercase tracking-wide">City *</label>
                  <input 
                    required
                ...
                <div className="space-y-1">
                  <label className="text-[9px] font-semibold text-neutral-500 uppercase tracking-wide">State *</label>
                  <input 
                    required
                ...
                <div className="space-y-1">
                  <label className="text-[9px] font-semibold text-neutral-500 uppercase tracking-wide">PIN Code *</label>
                  <input 
                    required
