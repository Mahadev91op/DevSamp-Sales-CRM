        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-neutral-100 p-6 rounded-2xl shadow-xs space-y-4">
            ...
            <div className="space-y-3">
              <div className="space-y-1">
                <span className="text-[9px] font-bold text-neutral-400 uppercase tracking-wide">Google Maps Embed API</span>
                <input 
                  type="password" disabled value="GOOGLE_MAPS_KEY_MOCK_XYZ123"
                  className="w-full p-2 rounded-lg border text-[10px] bg-neutral-50 text-neutral-400 font-mono"
                />
              </div>
              <div className="space-y-1">
                <span className="text-[9px] font-bold text-neutral-400 uppercase tracking-wide">Cloudinary Asset Upload API</span>
                <input 
