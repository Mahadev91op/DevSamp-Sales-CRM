  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-xl font-bold text-neutral-800 dark:text-neutral-50 tracking-tight">Intelligence & Reports</h1>
          <p className="text-xs text-neutral-400 dark:text-neutral-500 mt-1">Review team performance, loss reasons, and competitor analytics</p>
        </div>
        <div className="flex gap-2">
          <button 
            onClick={() => handleExportCSV('Sales Pipeline Summary')}
            className="flex items-center gap-1.5 bg-neutral-100 hover:bg-neutral-200 text-neutral-700 dark:bg-neutral-800 dark:hover:bg-neutral-700 dark:text-neutral-200 px-3 py-2 rounded-xl text-xs font-semibold cursor-pointer select-none transition-all"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-[#131b26] border border-neutral-100 dark:border-neutral-800 p-5 rounded-2xl shadow-xs">
          ...
          <div className="flex items-center gap-3 mt-3">
            ...
            <div>
              <p className="text-xs font-bold text-neutral-800 dark:text-neutral-100">Mumbai</p>
        ...
        <div className="bg-white dark:bg-[#131b26] border border-neutral-100 dark:border-neutral-800 p-5 rounded-2xl shadow-xs">
          ...
          <div className="flex items-center gap-3 mt-3">
            ...
            <div>
              <p className="text-xs font-bold text-neutral-800 dark:text-neutral-100">8.5 Days</p>
        ...
        <div className="bg-white dark:bg-[#131b26] border border-neutral-100 dark:border-neutral-800 p-5 rounded-2xl shadow-xs">
          ...
          <div className="flex items-center gap-3 mt-3">
            ...
            <div>
              <p className="text-xs font-bold text-neutral-800 dark:text-neutral-100">Ravi Kumar</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-[#131b26] border border-neutral-100 dark:border-neutral-800 p-6 rounded-2xl shadow-xs space-y-4">
          <div>
            <h3 className="text-xs font-semibold text-neutral-800 dark:text-neutral-100">Market Intelligence (ERP Share)</h3>
        ...
        <div className="bg-white dark:bg-[#131b26] border border-neutral-100 dark:border-neutral-800 p-6 rounded-2xl shadow-xs space-y-4">
          <div>
            <h3 className="text-xs font-semibold text-neutral-800 dark:text-neutral-100">Deal Loss Reasons Analysis</h3>
      ...
      <div className="bg-white dark:bg-[#131b26] border border-neutral-100 dark:border-neutral-800 p-6 rounded-2xl shadow-xs space-y-4">
        <div>
          <h3 className="text-xs font-semibold text-neutral-800 dark:text-neutral-100">Team Leaderboard Performance</h3>
          ...
          <table className="w-full text-left border-collapse text-xs">
            ...
            <tbody className="divide-y divide-neutral-50 dark:divide-neutral-800/80">
              {executiveLeaderboard.map((exec, idx) => (
                <tr key={idx} className="hover:bg-neutral-50/30 dark:hover:bg-[#161f2b]/30">
                  <td className="p-3 font-semibold text-neutral-800 dark:text-neutral-200">{exec.name}</td>
                  <td className="p-3 text-neutral-500 dark:text-neutral-400">{exec.deals}</td>
                  <td className="p-3">
                    <div className="flex items-center gap-2">
                      <span className="font-semibold text-neutral-800 dark:text-neutral-200">{exec.score}/100</span>
